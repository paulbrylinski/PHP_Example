...
<h1>Heat Index</h1>
<p>
    In the Summer, when people say "It’s not the heat, it’s the humidity", what do they mean? There are 2 factors that
    make a hot day feel really hot. The first is the air temperature and the second is relative humidity. After taking
    measurements for temperature and relative humidity, we can calculate a heat index that is called our “feels like”
    temperature.
</p>
<p>
...
<p>
    If you need to take the temperature, but don't have a Thermometer, then see our
    <a href="workshops.php">Weather Workshops</a> to find a workshop on How to make a Thermometer.
</p>
