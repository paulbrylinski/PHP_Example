...
function create_ad() {
	echo '<p class="ad">Don\'t Forget to <a href="registration.php">Register</a> to Become a Weather Wizard!</p>';
...
<h1>Weather Wizards</h1>
	...
	<p>Welcome to the Weather Wizards Website for budding meterologists in the Southern Lowcountry Area.</p>
